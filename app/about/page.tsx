...
const teamMembers = [
  {
    ...
    image: "/pro                                                                                                                                                         fessional-woman-engineer-smiling-portrait.jpg",
    ...
    technologies: ["Node.js","React","Spring Boot", "IOT", "Eletronic", "Industrial Protocols","Docker","Kubernetes","Redis","API RESTful","Machine Learning","Git/Github"],
  ...
  },
  {
    ...
    technologies: ["Spring Boot", "FastAPI","Fastify", "Docker", "React", "Node.js", "API RESTful", "IOT","Git/Github"],
  ...
  },
  {
    ...
    technologies: ["Flask","React","Node.js", "Git/Github","PyQt","Blender3D"],
  ...
  {
    id: 4,
    name: "Daniel Rodrigues Santos",
    role: "Hardware Engineer",
    image: "/professional-man-electronics-engineer-portrait.jpg",
    bio: "Engenheiro de hardware especializado em desenvolvimento de gateways IoT e sensores industriais.",
    technologies: ["C/C++", "ARM", "ESP32", "LoRaWAN", "PCB Design"],
    linkedin: "https://linkedin.com/in/danielsantos",
    github: "https://github.com/danielsantos",
    whatsapp: "5511966666666",
  },
  {
    id: 5,
    name: "Fernanda Lima Pereira",
    role: "UX/UI Designer",
    image: "/professional-woman-designer-creative-portrait.jpg",
    bio: "Designer de produto focada em criar interfaces intuitivas para sistemas complexos de monitoramento industrial.",
    technologies: ["Figma", "React", "Tailwind CSS", "Design Systems", "Prototyping"],
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-6 animate-fade-in-up">
            <div className="inline-block px-4 py-2 rounded-full bg-primary/10 border border-primary/20">
              <p className="text-sm font-semibold text-primary uppercase tracking-wider">Quem Somos Nós</p>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-balance max-w-4xl mx-auto">
              ...
              <span className="text-primary bg-clip-text">monitoramento IoT industrial</span>
            </h1>
            <p className="text-xl text-muted-foreground text-balance max-w-3xl mx-auto leading-relaxed">
              Somos um time multidisciplinar de especialistas apaixonados por tecnologia e inovação, dedicados a
              transformar a indústria através de soluções IoT inteligentes.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="text-center space-y-4 pb-6 border-b border-border/50">
            <p className="text-base text-foreground leading-relaxed max-w-4xl mx-auto">
              Somos estudantes do{" "}
              <span className="font-semibold text-primary">Curso Técnico em Análise e Desenvolvimento de Sistemas</span>{" "}
              na <span className="font-semibold text-primary">Faculdade de Tecnologia SENAI Antonio Adolpho Lobbe</span>
              . Juntos, desenvolvemos o projeto IoTurn como parte de nossa formação acadêmica, aplicando conhecimentos
              de programação, IoT, análise de dados e design de sistemas para criar uma solução inovadora de
    ...
    >
      ...
      <div className="relative h-80 overflow-hidden bg-gradient-to-br from-primary/5 to-primary/10">
        ...
        <div className="absolute bottom-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0">
          <Link href={member.linkedin} target="_blank" rel="noopener noreferrer">
            <Button size="icon" variant="secondary" className="h-9 w-9 rounded-full shadow-lg backdrop-blur-sm">
          ...
          <Link
            href={`https://wa.me/${member.whatsapp}?text=Olá%20${encodeURIComponent(member.name)}!%20Vi%20seu%20perfil%20no%20IoTurn`}
            target="_blank"
      ...
      <div className="p-6 space-y-4">
        <div>
          ...
          <p className="text-sm font-semibold text-primary/80 mt-1">{member.role}</p>
        </div>
